...
def load_price_dataset(
    ...
    if dataset_type == "paperswithbacktest":
        ...
        df = pd.read_csv(os.path.join("data", "price", "sp500_prices_2000_2024.csv.csv")) if dataset_type == "sp500" else pd.read_parquet(os.path.join("data", "price", "stock_price_daily.parquet"))
